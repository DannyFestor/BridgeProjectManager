...
const project = computed<Project>(() => usePage().props.project.data);
...
<template>
  <button
    @click="onOpen"
    class="ml-auto mr-8 mb-8 flex items-center gap-2 rounded bg-pink-800 px-4 py-2 text-pink-50 hover:bg-pink-700 dark:bg-pink-300 dark:text-pink-800 dark:hover:bg-pink-200"
  >
    Leave Project
      ...
      >
        ...
        >
          ...
          <div class="flex justify-end gap-4">
            ...
            <DangerButton @click="onDelete">Leave</DangerButton>
          </div>
        </div>
      </div>
    </Transition>
